...
> A collection of basic programming examples in **Python**, **Java**, and **JavaScript**.
...
Use the `python`, `javac`, or `node` commands to execute the programs.
...
- [x] Python programs added
- [x] Java programs added
- [x] JavaScript programs added
- [x] README created
